...
{
    public class JavaHighlighter : ISyntaxHighlighter
    {
        private static readonly HashSet<string> Keywords =
            new HashSet<string>
            {
                "public","private","class","void","int","float","double",
                "String","boolean","return","if","else","for","while",
                "new","static","import","package","true","false","null"
            };
